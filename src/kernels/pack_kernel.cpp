...
void pack_all(
    ...
    if (fields[FIELD_U])       pack_func(x_min, x_max, y_min, y_max, halo_exchange_depth, u, mpi_buffer, depth, xincs(CELL_DATA), yincs(CELL_DATA), tile_offset + offsets[FIELD_U], edge_minus, edge_plus);
    if (fields[FIELD_P])       pack_func(x_min, x_max, y_min, y_max, halo_exchange_depth, p, mpi_buffer, depth, xincs(CELL_DATA), yincs(CELL_DATA), tile_offset + offsets[FIELD_P], edge_minus, edge_plus);
    if (fields[FIELD_SD])      pack_func(x_min, x_max, y_min, y_max, halo_exchange_depth, sd, mpi_buffer, depth, xincs(CELL_DATA), yincs(CELL_DATA), tile_offset + offsets[FIELD_SD], edge_minus, edge_plus);
    if (fields[FIELD_R])       pack_func(x_min, x_max, y_min, y_max, halo_exchange_depth, r, mpi_buffer, depth, xincs(CELL_DATA), yincs(CELL_DATA), tile_offset + offsets[FIELD_R], edge_minus, edge_plus);
    if (fields[FIELD_Z])       pack_func(x_min, x_max, y_min, y_max, halo_exchange_depth, z, mpi_buffer, depth, xincs(CELL_DATA), yincs(CELL_DATA), tile_offset + offsets[FIELD_Z], edge_minus, edge_plus);
    if (fields[FIELD_KX])      pack_func(x_min, x_max, y_min, y_max, halo_exchange_depth, kx, mpi_buffer, depth, xincs(CELL_DATA), yincs(CELL_DATA), tile_offset + offsets[FIELD_KX], edge_minus, edge_plus);
    if (fields[FIELD_KY])      pack_func(x_min, x_max, y_min, y_max, halo_exchange_depth, ky, mpi_buffer, depth, xincs(CELL_DATA), yincs(CELL_DATA), tile_offset + offsets[FIELD_KY], edge_minus, edge_plus);
