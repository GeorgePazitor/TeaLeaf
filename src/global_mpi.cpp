...
void tea_sum(double& value) {
    ...
    // reduction sum targeting the root process 0
...
// optimized global sum reduction for two values simultaneously, bundling values into a single MPI call reduces network latency overhead.
